...
PICS = (environ.get('PICS', 'https://mallucampaign.in/images/img_1722062892.jpg https://mallucampaign.in/images/img_1722062893.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002177098038 -1002162874412').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002110573828') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002162874412 -1002177098038')).split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/NarutoKD_Movies_Group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/NarutoKD_Update')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/NarutoKD_Update/2')
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/NarutoKD_Update/2')
